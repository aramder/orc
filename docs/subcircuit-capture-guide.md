...
**GPIO reservation for node-ID DIP switch — superseded, see the "CAN node address" entry further down this section** (2026-08-04, as-fabbed pins GPIO0–3, not the GPIO0/1/3/10 originally planned when this note was first written 2026-08-02). Kept here only as a pointer so this paragraph doesn't contradict the later, accurate one.
