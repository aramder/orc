...
| ID | Title | Status |
|---|---|---|
| FR-001 | USB bench/debug interface firmware (`usb_bench`) | superseded by FR-004 (2026-08-05) — `usb_bench` retired, its function consolidated into `canopen_app`. Real-hardware findings/fixes stay valid history. |
...
| FR-004 | Consolidate `usb_bench` into `canopen_app` — drive relays from CAN or USB | in-progress (2026-08-05) |
